Jbygg Front-End Booking Application

This project is a front-end application built for Jbygg. The application features a booking form with form validation, enabling users to easily schedule appointments with Jbygg. The project is built with React and does not use an SQL database, keeping it lightweight and focused on client-side validation and functionality.
